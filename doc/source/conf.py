...
# documentation.
#
html_theme_options = dict(sticky_navigation=True)
...
latex_documents = [
    (master_doc, 'survive.tex', 'survive Documentation',
     'Artem Mavrin', 'manual'),
]
...
.. only:: html
    ...
    .. nbinfo::
        ...
        :raw-html:`<a href="https://mybinder.org/v2/gh/artemmavrin/survive/master?filepath={{ docname }}">
